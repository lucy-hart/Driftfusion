...
%% Input parameters
params_filepath = './PEM_workshop_Input_files/1_layer_device.csv';     % Filepath to the parameters file
...
sol_CV = doCV(sol_eq.el, light_intensity, Vmin, Vmax, Vmin, scan_rate, 0.5, 401);
