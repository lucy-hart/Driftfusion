...
try
    ...
    warning('No conduction band tail state Urbach energy (E_UCB) defined in .csv . Using default in PC')
end

try
    par.E_UVB = T{:, 'E_UVB'}';
catch
    warning('No valence band tail state Urbach energy (E_UVB) defined in .csv . Using default in PC')
end
...
try
    ...
    try
        ...
        warning('No SRH electron lifetime array (Cn_CB) defined in .csv . Using default in PC')
    end
end
...
try
    ...
    try
        ...
        warning('No SRH hole lifetime array (Cp_CB) defined in .csv . Using default in PC')
    end
end
...
try
    ...
    try
        ...
        warning('No SRH electron lifetime array (Cn_VB) defined in .csv . Using default in PC')
    end
end
% Hole SRH time constant
try
    ...
    try
        ...
        warning('No SRH hole lifetime array (Cp) defined in .csv . Using default in PC')
    end
end
...
try
    ...
    try
        ...
        warning('No electron trap energy array (Et_CB) defined in .csv . Using default in PC')
    end
end
...
try
    ...
    warning('No electron trap energy array (Et_VB) defined in .csv . Using default in PC')
end
...
try
    ...
    warning('No CB trap density array (Nt_CB) defined in .csv . Using default in PC')
end

try
    par.Nt_VB = T{:,'Nt_VB'}';
catch
    warning('No VB trap density array (Nt_p) defined in .csv . Using default in PC')
end
% Optical model
try
    par.OM = T{1, 'OM'};
