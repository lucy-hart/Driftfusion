...
if CVsol.par.vsr_mode == 0
    J_values(:,3) = e*trapz(x, not(CVsol.par.dev_sub.int_switch).*loss_currents.srh, 2)';
    J_values(:,4) = e*trapz(x, CVsol.par.dev_sub.int_switch.*loss_currents.srh, 2)';
elseif CVsol.par.vsr_mode == 1
