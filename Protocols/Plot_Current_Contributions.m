...
x = CVsol.par.x_sub;
%num_points = cast(length(x)/2, 'int32');
...
J_values(:,4) = e*trapz(x, loss_currents.srh_p, 2)';
...
line_colour = {[0.8500 0.3250 0.0980], [0.9290 0.6940 0.1250], ...
                [0 0.4470 0.7410], [0.3010 0.7450 0.9330], [0.4940 0.1840 0.5560],...
...
legend({'J_{gen}', 'J_{rad}x100', 'J_{SRH,n}', 'J_{SRH,p}', 'J_{surface}', 'J_{ext}'}, 'Location', 'bestoutside')
